...
class DummyProtocol(Protocol):
    ...
    def train_step(self, batch):
        ...
        loss_ref = model.compiled_loss(
            labels, predictions, regularization_losses=reg_losses
        )
...
@combinations.generate(combinations.combine(run_eagerly=[True, False]))
    ...
    def test_strategy_call(self, run_eagerly):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            try:
                ...
                self.fail(
                    "The loss from keras compiled model is"
