...
if __name__ == "__main__":
    ...
    logger.info(f'Forward call of the keras module {module(tf.constant(6.0, shape= (1, 1)))}')
    logger.info(f'Forward call of the restored module {restored_module(tf.constant(6.0, shape= (1, 1)))}')
