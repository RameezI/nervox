...
"""Padding module for nervox."""

from typing import Callable, Sequence, Union, TypeVar, Tuple
import collections
...
def create(
    ...
    effective_kernel_size = map(
        ...
        replicate(kernel, n, "kernel"),
        replicate(rate, n, "rate"),
    )
    paddings = map(
        lambda x, y: x(y), replicate(padding, n, "padding"), effective_kernel_size
    )
